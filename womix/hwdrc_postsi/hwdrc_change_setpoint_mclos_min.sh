...
g_ATTRIBUTES_MCLOS0=0x80000000
g_ATTRIBUTES_MCLOS1=0x81100005
g_ATTRIBUTES_MCLOS2=0x8220000a
#g_ATTRIBUTES_MCLOS3=0x8360A00F
input_mclos_min=$2
g_ATTRIBUTES_MCLOS3=`printf "0x%08x\n" $((0x83FF000F + input_mclos_min*256))`
