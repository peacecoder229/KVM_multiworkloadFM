source /home/meiqi/womix/hwdrc_postsi/hwdrc_osmailbox_config.inc.sh
...
#echo "Set max, min to 3.0Ghz"
#ret=`cpupower frequency-set -u 3000Mhz`
#ret=`cpupower frequency-set -d 3000Mhz`

pqos -R
#umount /sys/fs/resctrl

echo "disable DRC for Scoket0"
core_id=1
hwdrc_disable

echo "disable DRC for Scoket1"
#D0
#core_id=33
#56C
core_id=57
